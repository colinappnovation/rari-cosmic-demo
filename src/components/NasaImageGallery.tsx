import { getPlanetImages } from '@/data/nasa'
...
export default function NasaImageGallery({ planetId, title }: Props) {
  const images = getPlanetImages(planetId)
